...
.div_p{
	...
	#container_table tr:nth-child(even){background-color: #f2f2f2;}

	#container_table tr:hover {background-color: #ddd;}
...
<div id="main_menu">
 ...
 <div  id="container_table">
  <center><h3>Check Container</h3></center>
<?php
  ...
  if(mysqli_num_rows($result)>0){
    ...
    echo'<center><table ><tr><th>No.</th><th>Container ID</th><th>Container Model</th><th>Description</th><th>Status</th></tr>';
     
      while($row = mysqli_fetch_assoc($result)){
          $row_num++;
          echo'<tr ><td>'.$row_num.'</td><td>'.$row["container_id"].'</td><td>'.$row["Model"].'</td><td>'.$row["description"].'</td><td>'.$row["status"].'</td></tr>';}
      echo'</center></table>';
