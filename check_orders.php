...
.div_p{
	...
	#orders_table tr:nth-child(even){background-color: #f2f2f2;}

	#orders_table tr:hover {background-color: #ddd;}
...
<div id="main_menu">
 ...
 <!--- display Order table-->
 <div  id="orders_table">
  <center><h3>Check Orders Details</h3></center>
<?php
  ...
  $query = "SELECT *FROM orders where status='Loaded' or status='Rejected,Try Again' or status='Process'";
