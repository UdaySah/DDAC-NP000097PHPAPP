...
<div id="main_menu">
 ...
 <div  id="table_schedule">
  <center><h3>Check Booked Orders</h3></center>
<?php
  ...
  if(mysqli_num_rows($result)>0){
    ...
    echo'<center><table><tr><th>No.</th><th>Order ID</th><th>Depature</th><th>Destination</th><th>Sender Name</th><th>Sender Phone</th><th>Receiver Name</th><th>Receiver Phone</th><th>Container</th><th>Status</th><th>Function</th></tr>';
      // output data of each row
      while($row = mysqli_fetch_assoc($result)){
          $row_num++;
          echo'<tr class="thead-light"><td>'.$row_num.'</td><td>'.$row["Order_ID"].'</td><td>'.$row["Depature"].'</td><td>'.$row["Destination"].'</td><td>'.$row["Sender_name"].'</td><td>'.$row["Sender_Phone"].'</td><td>'.$row["Receiver_name"].'</td><td>'.$row["Receiver_Phone"].'</td><td>'.$row["container_model"].'</td><td>'.$row["status"].'</td><td><a class="accept_btn" href="delivered.php?id='.$row["container_model"].'">Delivered</a></td></tr>';}
      echo'</center></table>';
