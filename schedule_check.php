 ...
 <center><h3>Check Schedule</h3></center>
	<?php
	  ...
	  if(mysqli_num_rows($result)>0){
		...
		echo'<center><table class="schetable_table" ><tr><th>Departure</th><th>Depart Time</th><th>Arrival</th><th>Arrival Time</th></tr>';
		  
		  while($row = mysqli_fetch_assoc($result)){

			  echo'<tr><td>'.$row["Warehouse_Location"].'</td><td>'.$row["Depart"].'</td><td>'.$row["Destination"].'</td><td>'.$row["Arrival"].'</td></tr>';}
		  echo'</center></table>';
